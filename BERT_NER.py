...
flags.DEFINE_string("tpu_name", None, "Specify name of TPU machine.")

flags.DEFINE_string("tpu_zone", None, "Specify zone of TPU machine.")

flags.DEFINE_string('gcp_project',None, 'Specify GCP Project för TPU machine')
...
def main(_):
    ...
    if FLAGS.use_tpu and FLAGS.use_tpu:
        assert FLAGS.gcp_project != None
        assert FLAGS.tpu_zone != None
        assert FLAGS.tpu_name != None
        print('Resolving TPU Cluster...')
        tpu_cluster_resolver = tf.contrib.cluster_resolver.TPUClusterResolver(
            FLAGS.tpu_name, zone=FLAGS.tpu_zone, project=FLAGS.gcp_project)
    elif FLAGS.use_tpu and FLAGS.use_tpu == None:
        raise ValueError('use_tpu set to True, while no TPU Name where specified. Please specify --tpu_name=')
